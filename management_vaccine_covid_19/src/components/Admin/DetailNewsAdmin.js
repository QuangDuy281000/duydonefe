...
import PublicAdmin from "../../services/admin/PublicAdmin"
function DetailNewsAdmin() {
  ...
  return (
    <>
      ...
      <div className="container-fluid rounded bg-white ps-2" style={{height:"490px"}}>
        <div className="row">
